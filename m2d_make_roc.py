...
def assess_model(model_predict, x_valid, y_valid, threshold):
    '''
    ...
    # hiker
    probability_of_hiker = model_predict(x_valid)
    ...
    # handy method
    return calculate_tpr_fpr(predicted_is_hiker, y_valid)


def create_roc_curve(model_predict, x_valid, y_valid):
    '''
    ...
    for threshold in thresholds:
        # calculate the true and false positives rates using our
        # handy method
        tpr, fpr = assess_model(model_predict, x_valid, y_valid, threshold)
